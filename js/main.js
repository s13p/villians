    ...
    if (document.querySelectorAll('.offer')) {
        ...
        function handleScroll() {
            ...
            if (scrollTop >= offerSectionTop && scrollTop <= offerSectionBottom) {
                ...
                const offsetYOfferFrontSecondRocks = -(scrollTop - offerSectionTop) * 0.3
                ...
                gsap.to(offerGround, {
                    duration: 1,
                    y: offsetYOfferGround
                })
                gsap.to(heroesV, {
                    duration: 1,
                    y: offsetYHeroesV
                })
                gsap.to(offerMeteorite, {
                    duration: 1,
                    y: offsetYOfferMeteorite
                })
                gsap.to(offerFrontSecondRocks, {
                    duration: 1,
                    y: offsetYOfferFrontSecondRocks,
                })
                gsap.to(offerBackRocks, {
                    duration: 1,
                    y: offsetYOfferBackRocks
                })
                gsap.to(offerFrontRocks, {
                    duration: 1,
                    y: offsetYOfferFrontRocks
                })
                gsap.to(offerTTest, {
                    duration: 1,
                    y: offsetYOfferTTest
...
function textAnimationAbout() {
    if (document.querySelector('.box__first')) {
        ...
        const descriptionP2 = document.querySelector(
            'body > div.parallax > section.about > div.container > div.about__union > div.about__block > div.block__description > p:nth-child(2)'
        )
